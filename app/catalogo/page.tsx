...
export default function Catalogo() {
  return <main className="catalog-page">
    <header className="nav-shell"><Link href="/" className="brand"><Image src="/fg-tow-logo.png" alt="FG TOW" width={190} height={58} priority unoptimized /></Link><nav><Link href="/">Inicio</Link><a href="#modelos">Modelos</a><Link href="/#proceso">Proceso</Link></nav><Link className="button button-small" href="/#cotizar">Cotizar proyecto</Link></header>
    ...
    <footer><Link href="/" className="footer-brand"><Image src="/fg-tow-logo.png" alt="FG TOW" width={170} height={54} unoptimized /></Link><p>Remolques para negocio, aventura y trabajo.</p><div><Link href="/">Inicio</Link><Link href="/#cotizar">Cotizar</Link></div><small>© 2026 FG TOW · Parte de FG PRO</small></footer>
  </main>;
}
