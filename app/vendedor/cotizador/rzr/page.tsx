...
export const metadata = { title: "Vendedor · FG RZR Sport", robots: { index: false, follow: false } };

export default async function VendedorCotizadorRzrPage() {
  await requireVendor("/vendedor/cotizador/rzr");
