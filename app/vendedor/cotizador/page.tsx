...
export const metadata = { title: "Cotizadores", robots: { index: false, follow: false } };
...
export default async function VendedorCotizadorIndexPage() {
  const vendor = await requireVendor("/vendedor/cotizador");
  ...
  return <main className="vendor-panel">
    ...
    <section className="vendor-panel-shell">
      ...
      <h1>Cotizadores<br /><em>completos.</em></h1>
      <p>Elige el modelo para empezar una cotización nueva desde cero, con el plano interactivo completo.</p>
