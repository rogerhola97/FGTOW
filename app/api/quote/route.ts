      ...
      try {
        const emailResponse = await fetch("https://api.resend.com/emails", {
          ...
          body: JSON.stringify({
            ...
            to: [toEmail],
            reply_to: email,
            subject: `${folio} · Food truck ${(quote.preset.widthCm / 100).toFixed(2)} × ${(quote.preset.lengthCm / 100).toFixed(2)} m · ${name}`,
